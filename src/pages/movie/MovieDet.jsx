...
const MovieDet = () => {
  ...
  const getMoiveById = async () => {
    ...
    try {
      const res = await axios.get(
        `${API_URL}/movie/${movId}?api_key=${API_KEY}`
      );
      // console.log(res);
  ...
  const getCreditsById = async () => {
    try {
      const res = await axios.get(
        `${API_URL}/movie/${movId}/credits?api_key=${API_KEY}`
      );
      // console.log(res);
  ...
  const getrecommended = async () => {
    try {
      const res = await axios.get(
        `${API_URL}/movie/${movId}/recommendations?api_key=${API_KEY}`
      );
      // console.log(res);
  ...
  return (
    <>
      <div className="category__det__box">
        ...
        <TopRate text="Recommended Movies" list={moviereco} />
      </div>
    </>
  );
};
